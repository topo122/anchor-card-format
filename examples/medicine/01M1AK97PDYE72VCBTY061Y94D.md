...
What holds the membrane potential nearly flat during the plateau?

<!-- hint -->
Two currents of opposite direction, running at the same time.

<!-- back -->
Inward **calcium** current through L-type Ca2+ channels is balanced by outward **potassium** current, so the two nearly cancel and the potential changes very little for a couple of hundred milliseconds.
